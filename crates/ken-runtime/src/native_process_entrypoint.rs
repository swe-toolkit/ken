...
pub struct NativeProcessSymbols {
    ...
    pub mk_instant: RuntimeSymbol,
    pub read_chunk: RuntimeSymbol,
    pub read_result_eof: RuntimeSymbol,
...
impl NativeProcessSymbols {
    pub(crate) fn legacy_prelude() -> Self {
        Self {
            ...
            mk_instant: "ctor:prelude::Instant::MkInstant".to_string(),
            read_chunk: "ctor:prelude::ReadResult::Chunk".to_string(),
            read_result_eof: "ctor:prelude::ReadResult::Eof".to_string(),
