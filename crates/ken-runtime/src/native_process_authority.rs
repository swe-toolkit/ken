...
fn native_process_symbols_from_record(
    ...
    NativeProcessSymbols {
        ...
        file_operation_metadata: spine.file_operation_metadata.clone(),
        file_metadata: spine.file_metadata.clone(),
        file_kind_file: spine.file_kind_file.clone(),
        ...
        file_operation_read_directory: spine.file_operation_read_directory.clone(),
        file_operation_create_directory: spine.file_operation_create_directory.clone(),
