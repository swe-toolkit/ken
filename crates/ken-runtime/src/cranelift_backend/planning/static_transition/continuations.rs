...
pub(in crate::cranelift_backend) struct FusionComposedEdge {
    pub(super) fusion: StaticContinuationFusionId,
    pub(super) target: ContinuationSpecializationId,
    pub(super) emission_owner: ContinuationEmissionOwner,
    pub(super) consumer_continuation_origin: StaticOriginId,
    pub(super) producer_construct_origin: StaticOriginId,
    pub(super) layer: FusionCompositionLayer,
}
...
pub(in crate::cranelift_backend) struct FusionOwnedOuterRealization {
    ...
    pub(super) emission_owner: ContinuationEmissionOwner,
    pub(super) consumer_continuation_origin: StaticOriginId,
    pub(super) selected_case_body: StaticOriginId,
    pub(super) producer_body: StaticOriginId,
}
...
thread_local! {
    ...
    pub(super) static MUTATE_PRIMARY_FUSION_KEY_DERIVATION: Cell<bool> = const { Cell::new(false) };
...
#[cfg_attr(not(test), allow(dead_code))]
#[derive(Clone, Copy, Debug, Eq, Ord, PartialEq, PartialOrd)]
pub(in crate::cranelift_backend) struct StaticContinuationFusionId(pub(super) u32);
...
pub(in crate::cranelift_backend) struct StaticContinuationFusionKey {
    pub(super) admitted: AdmittedContinuationDiscovery,
    pub(super) producer_construct_origin: StaticOriginId,
    pub(super) producer_owner: PredeclaredFunctionId,
    pub(super) producer_alternative: u32,
    pub(super) recursive_position: u32,
    pub(super) producer_argument_origin: StaticOriginId,
    pub(super) producer_argument_binding: CheckedIhBinding,
    pub(super) selected_case_body: StaticOriginId,
    pub(super) consuming_call: StaticOriginId,
    pub(super) consuming_callee: StaticOriginId,
    pub(super) consumer_binding: CheckedIhBinding,
    pub(super) checked_transport: CheckedTransportCoordinate,
    pub(super) invocation_caller: PredeclaredFunctionId,
    pub(super) invocation_callee: PredeclaredFunctionId,
    pub(super) invocation_callee_entry: StaticOriginId,
    pub(super) consumer_owner: PredeclaredFunctionId,
    pub(super) continuation_inputs: Vec<ContinuationSourceSlotAuthority>,
}
...
#[cfg_attr(not(test), allow(dead_code))]
pub(super) fn primary_fusion_key(candidate: &StaticContinuationFusionCandidate) -> StaticContinuationFusionKey {
...
#[cfg_attr(not(test), allow(dead_code))]
pub(super) fn rederive_fusion_key(
    plan: &StaticTransitionPlan<'_>,
    oriented: &crate::OrientedSubcontinuationPlanV1,
...
pub(in crate::cranelift_backend) struct StaticContinuationFusionDescriptor {
    ...
    pub(super) continuation_inputs: usize,
    pub(super) recursive_position: u32,
    pub(super) consumer_owner: PredeclaredFunctionId,
    pub(super) producer_owner: PredeclaredFunctionId,
}
...
pub(in crate::cranelift_backend) struct StaticContinuationFusionPlan {
    pub(super) keys: Vec<StaticContinuationFusionKey>,
    pub(super) descriptors: Vec<StaticContinuationFusionDescriptor>,
    ...
    pub(super) walked_admitted_continuation_discoveries: usize,
}
...
impl StaticContinuationFusionPlan {
    ...
    /// different key.
    pub(super) fn id_for(&self, key: &StaticContinuationFusionKey) -> Option<StaticContinuationFusionId> {
        self.keys
            .iter()
    ...
    /// ID -> key.
    pub(super) fn key_for(&self, id: StaticContinuationFusionId) -> Option<&StaticContinuationFusionKey> {
    ...
    pub(super) fn installed_keys(&self) -> &[StaticContinuationFusionKey] {
        &self.keys
    }
}
...
pub(in crate::cranelift_backend) struct StaticContinuationFusionView<'plan> {
    pub(super) id: StaticContinuationFusionId,
    pub(super) key: &'plan StaticContinuationFusionKey,
    pub(super) planned: &'plan StaticContinuationFusionDescriptor,
    pub(super) header: AbiFrameHeader,
    pub(super) slots: &'plan [AbiSlot],
    pub(super) inputs: &'plan [abi::AbiContinuationInputAuthority],
}
...
pub(in crate::cranelift_backend) struct FusionOwnedBody {
    pub(super) producer: PredeclaredFunctionId,
    pub(super) fusion: StaticContinuationFusionId,
}
...
pub(in crate::cranelift_backend) struct FusionRegionClaim {
    ...
    pub(super) redirect: EmittableCallEdge,
    ...
    pub(super) invocation_parameters: Vec<StaticOriginId>,
...
pub(super) fn fusion_claim_error(cause: FusionClaimRefusal) -> CraneliftBackendError {
...
pub(in crate::cranelift_backend) struct FusionRegionClaimLedger {
    ...
    pub(super) planned: BTreeSet<StaticContinuationFusionId>,
    pub(super) claims: BTreeMap<StaticContinuationFusionId, FusionRegionClaim>,
    ...
    pub(super) consumed: BTreeMap<StaticContinuationFusionId, StaticOriginId>,
    /// The regions for which a `Fusion(id)` definition was emitted.
    pub(super) defined: BTreeSet<StaticContinuationFusionId>,
    /// The regions whose named invocation was actually redirected.
    pub(super) redirected: BTreeSet<StaticContinuationFusionId>,
    ...
    pub(super) body_owned: BTreeSet<StaticContinuationFusionId>,
    ...
    pub(super) body_owned_recorded: bool,
}
...
#[cfg(test)]
thread_local! {
    pub(super) static FUSION_CLAIM_PARAMETER_MUTATION: Cell<FusionClaimParameterMutation> =
        const { Cell::new(FusionClaimParameterMutation::Exact) };
    pub(super) static FUSION_PRODUCER_CAPTURE_MUTATION: Cell<FusionProducerCaptureMutation> =
        const { Cell::new(FusionProducerCaptureMutation::Exact) };
    pub(super) static R3_FUSION_CLAIM_CONSUMPTIONS: std::cell::RefCell<
...
impl FusionRegionClaimLedger {
    ...
    pub(super) fn commit_body_owned(&mut self, owned: BTreeSet<StaticContinuationFusionId>) {
...
pub(super) fn fusion_unique_static_body_triple(
    plan: &StaticTransitionPlan<'_>,
    producer_owner: PredeclaredFunctionId,
) -> Result<
...
/// not guessed at.
pub(super) fn fusion_resolved_binder_body(
    plan: &StaticTransitionPlan<'_>,
...
pub(super) fn fusion_through_checked_wrappers(
    plan: &StaticTransitionPlan<'_>,
...
#[cfg_attr(not(test), allow(dead_code))]
pub(super) fn enumerate_live_fusion_candidates(
    plan: &StaticTransitionPlan<'_>,
    entry: &RuntimeExpr,
    declarations: &BTreeMap<&str, &RuntimeDeclaration>,
    oriented: Option<&crate::OrientedSubcontinuationPlanV1>,
...
pub(super) fn enumerate_live_fusion_candidates_with_input_size(
    plan: &StaticTransitionPlan<'_>,
    entry: &RuntimeExpr,
    declarations: &BTreeMap<&str, &RuntimeDeclaration>,
    oriented: Option<&crate::OrientedSubcontinuationPlanV1>,
...
#[cfg_attr(not(test), allow(dead_code))]
pub(super) fn fusion_root_source_for_future_enumerator(
    plan: &StaticTransitionPlan<'_>,
...
/// call.
#[cfg_attr(not(test), allow(dead_code))]
pub(super) fn admitted_continuation_discoveries(
    plan: &StaticTransitionPlan<'_>,
) -> Result<Vec<AdmittedContinuationDiscovery>, CraneliftBackendError> {
