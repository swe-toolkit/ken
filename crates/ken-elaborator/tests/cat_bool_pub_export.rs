...
fn class_owner_provider_loader_visible_inventories_are_exact() {
    assert_eq!(
        ...
        BTreeSet::from([
            ...
            "bool_and".to_owned(),
            "bool_and::assoc".to_owned(),
            "bool_and::comm".to_owned(),
            "bool_and::idempotent".to_owned(),
            "bool_and::intro".to_owned(),
            "bool_and::left".to_owned(),
            "bool_and::left_identity".to_owned(),
            "bool_and::right".to_owned(),
            "bool_and::right_identity".to_owned(),
            "bool_cases".to_owned(),
            "bool_eq".to_owned(),
            "bool_leq".to_owned(),
            "bool_or".to_owned(),
