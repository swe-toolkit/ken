    ...
    let artifact = ken_runtime::build_bound_process_starter_executable_artifact(
        ...
        &ken_runtime::BoundProcessEntrypoint {
            ...
            process_symbols: ken_runtime::NativeProcessSymbols {
                ...
                resource_kind_mapping: host_spine.resource_kind_mapping.to_string(),
                ...
                mk_instant: host_spine.mk_instant.to_string(),
                read_chunk: host_spine.read_chunk.to_string(),
                read_result_eof: host_spine.read_result_eof.to_string(),
...
fn checked_host_spine_v1(
    ...
    Ok(crate::erasure::CheckedHostSpineV1 {
        ...
        resource_kind_mapping: resolve_id(roles.resource_kind_mapping)?,
        ...
        mk_instant: resolve_id(roles.mk_instant)?,
        read_chunk: resolve_id(roles.read_chunk)?,
        read_result_eof: resolve_id(roles.read_result_eof)?,
...
fn canonical_checked_host_spine_v1_bytes(spine: &crate::erasure::CheckedHostSpineV1) -> Vec<u8> {
    ...
    for symbol in [
        ...
        // ABI-S6 D5a appends the now-native Mapping resource-kind role.
        &spine.resource_kind_mapping,
    ] {
...
mod d1b_role_c1_roster_identity {
    ...
    fn every_emitted_role_equals_its_canonical_global_id_projection() {
        ...
        let emitted: Vec<(&'static str, StableSymbol)> = vec![
            ...
            ("mk_instant", record.spine.mk_instant.clone()),
            ("read_chunk", record.spine.read_chunk.clone()),
            ("read_result_eof", record.spine.read_result_eof.clone()),
