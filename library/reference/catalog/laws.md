...
| [Tooling/Testing/Property](Tooling/Testing/Property.md) | `authored` | Private attached runner laws establish successful-lookup soundness, success completeness, first-counterexample recovery, and the two `gen_from_list` coherences. Concrete witnesses remain computations; the laws are checked but not public. |
