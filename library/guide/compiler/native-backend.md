...
starter path targets a narrow Ken-only executable route, and it records unavailable
...
its absence before object emission or linking, and packaging does not invent or
...
boundary. This page explains the current implementation, and native compilation is
