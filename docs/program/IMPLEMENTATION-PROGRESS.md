...
2026-08-14 13:07:42Z — from 264 issue file(s) in `docs/program/issues/`.
...
- `RT-LEXICAL-RECURSOR-CONSUMERS` blocked by `RT-CONTKEY-CONSUMING-OCCURRENCE` (status: ready)
