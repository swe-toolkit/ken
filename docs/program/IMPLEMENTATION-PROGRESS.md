...
2026-08-13 21:41:42Z — from 244 issue file(s) in `docs/program/issues/`.
...
- `LANG-COMMENT-CLASSIFIER-SHARED` blocked by `LANG-SURFACE-BLOCK-COMMENTS` (status: ready)
