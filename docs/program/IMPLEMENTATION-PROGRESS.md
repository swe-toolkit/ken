...
2026-08-10 11:23:47Z — from 201 issue file(s) in `docs/program/issues/`.
...
| `CONF-VERIFY-OLD-ROW-UNSATISFIABLE` | The seed's only unclaimed row states expect: accepts against a landed elaborator that rejects unconditionally, and the Coverage map rolls it up as a satisfied family | active | spec-enclave | S | none | — |
