...
2026-08-12 05:19:54Z — from 229 issue file(s) in `docs/program/issues/`.
...
- `RT-RECURSOR-TRANSPORT` blocked by `RT-LEXICAL-R3-FUSION-EMITTER` (status: draft)
