...
blocks: []
github: https://github.com/swe-toolkit/ken/pull/3201
...
`merged` — D1 (OrderedSearch) MERGED at `65bfa52db` (PR #3195); D2
(InsertionSort) MERGED at `324e2df98` (PR #3201). [[CAT-ORD-LEQ-PUB-EXPORT]] was MERGED at
