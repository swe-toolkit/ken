...
> ## MERGED 2026-09-17 at `10e75cb93656d5ea787bceaf754b2500b78de166`
>
> Blob-verified subsumed: `diff(merge-base, 10e75cb93)` against current
> `origin/main` is `LIVE=0` across all 10 touched files under
> `crates/ken-runtime/`.
