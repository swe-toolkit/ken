...
> hard-stopped an eighth time on this mechanism chain: the exact governed `K`
> application does NOT yield a fresh `R2` on four of five governed coordinates.
