...
> # CLOSED — STRUCTURALLY REFUTED AT HARD STOP 14. THE OBJECTIVE SURVIVES IN A
> # SUCCESSOR. (Architect ruling `evt_7gnw8s9k7rh6`, 2026-08-29.)
>
> **This node cannot deliver the required edge while forbidden to change the
> general composed-return protocol.** That is a structural refutation of the
> SCOPE, and the Architect ruled it directly: close/recut, and **do NOT create
> HS15 or another predecessor on this node.**
>
> **THE SEMANTIC OBJECTIVE IS NOT REFUTED.**
...
> seed from the fresh `R2`. Read this closure as "the scope was wrong", never as
> "the goal was wrong".
>
> **Successors, carrying the objective forward:**
...
> constructor-field material AND a live SSA handle for a later Tail route. An
> earlier coupling that survives must put it in runtime data, a capture, or
> long-lived control state (all already rejected), or thread it beside the
> ordinary constructed result — which IS arm 1. **Minting the certificate
> earlier is useful but does not remove the need for the widened return.**
>
> **No Runtime release follows from the ruling.** Fourteen stops established the
...
> # (Architect `evt_bm4trnrjpymy`, 2026-08-29). THIS IS WHAT CLOSED THE NODE.
>
