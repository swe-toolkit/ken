...
size: L
gate: none
depends_on: [SPEC-NESTED-IND, RT-JOIN-ORIGIN-ATTRIBUTION, RT-BODY-OCCURRENCE-PROVENANCE, RT-SPECIALIZED-MATCH-ATTRIBUTION, LANG-NESTED-MATCH-LIFT-ALIGNMENT, RT-DYNAMIC-ARM-SCALAR-MERGE, RT-NESTED-IH-NATIVE-REALIZATION]
blocks: [DS-9]
github: null
