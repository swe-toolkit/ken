...
blocks: [RT-BACKEND-SPLIT-CLOSURE]
github: null
...
**Cut item 17 of [[RT-BACKEND-MODULE-SPLIT]]**, which is a **phase record and
...
**The terminals and cleanup emitter family.** Trap emission, unreachable and
abort terminals, and end-of-function cleanup.

**This is the last owner move.** After its companion test move, item 18 is a
closure and a remeasure, not another extraction.
...
this slice just established** (trap-emission, terminal and cleanup controls).
Place multi-leaf fixtures **once**,
