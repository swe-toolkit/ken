...
for paths, expected in [(['docs/a.md'],'doc-only'),(['agent/a.md'],'doc-only'),(['library/a.md'],'doc-only'),(['crates/a.rs'],'full'),(['.github/workflows/ci.yml'],'full'),([], 'full'),(['docs//a.md'],'full'),(['docs/./a.md'],'full'),(['../x'],'full')]:
