...
REQUIRED_RT_PARITY_ARMS = {
    ...
    # CI-UNDER-TWENTY-MINUTES split arms, each independently schedulable.
    ...
    "checked_ih_fresh_result_coemission_only_is_not_paired",
    ...
    "checked_ih_fresh_result_pairing_leg_roster_covers_all",
    ...
    "composed_return_forward_ret_authority_removal_stripes_cover_all",
