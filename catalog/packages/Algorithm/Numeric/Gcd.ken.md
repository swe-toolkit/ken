...
quotient witnesses required by AC-1. Given quotient witnesses for any common
divisor, `divides_gcd` produces the witness required by AC-2. These declarations
