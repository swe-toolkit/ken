...
Generated support specs pass the ordinary formation, positivity, universe, and
constructor checks. Their generic `Term::Elim` uses pass the ordinary
eliminator checks, while terminal provenance excludes the host-only generation
and enclosing-registration steps.
